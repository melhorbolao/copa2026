...
const COL_DEFS = [
  ...
  { key: 'classif_col_delta_corte1', label: '∆ Corte 1',     description: 'Diferença de pontos para o 1º corte de eliminação (≈ posição 112)', enabled: true },
  { key: 'classif_col_delta_corte2', label: '∆ Corte 2',     description: 'Diferença de pontos para o 2º corte de eliminação (≈ posição 56)', enabled: true },
