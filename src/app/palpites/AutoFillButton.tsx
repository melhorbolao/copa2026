  ...
  return (
    <tr>
      <td colSpan={7} className="border-t border-verde-100 bg-verde-50 px-4 py-3">
        ...
        {/* Erro em modal destacado */}
        {fillError && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
            <div className="w-full max-w-sm rounded-2xl bg-white p-6 shadow-xl">
              <h3 className="text-base font-bold text-red-700">Erro ao preencher</h3>
              <p className="mt-2 text-sm text-gray-700">{fillError}</p>
              <div className="mt-4 flex justify-end">
                <button
                  onClick={() => setFillError('')}
