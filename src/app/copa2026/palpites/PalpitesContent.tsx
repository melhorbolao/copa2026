...
const TabelaClient = dynamic(
  () => import('@/app/copa2026/tabela/TabelaClient').then(m => ({ default: m.TabelaClient })),
        ...
        <div className="mb-4 mt-4">
          ...
          {filledBets < totalGroupMatches && (
            <p className="mt-2 text-xs text-amber-700 bg-amber-50 rounded-lg px-3 py-2 border border-amber-200">
              ...
              <Link href="/copa2026/palpites" className="font-semibold underline">Complete seus palpites →</Link>
            </p>
          )}
        </div>
      )}
          ...
          {totalMatches === 0 ? (
            ...
            <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
              ...
              <div className="mt-2 text-center">
                <Link
                  href="/copa2026/palpites?tab=classificacao"
                  className="inline-flex items-center gap-1.5 text-sm font-medium text-azul-escuro hover:underline"
                >
  ...
  return (
    <div>
      ...
      <div className="mt-3 flex gap-1 border-b border-gray-200 overflow-x-auto overflow-y-hidden [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
        <TabLink href="/copa2026/palpites"                       label="Meus Palpites"      active={activeTab === 'palpites'} />
        <TabLink href="/copa2026/palpites?tab=classificacao"     label="Minha Classificação" active={activeTab === 'classificacao'} />
        <TabLink href="/copa2026/palpites?tab=mata-mata"         label="Meu Mata-Mata"      active={activeTab === 'mata-mata'} />
      </div>
    </div>
  )
}
